...
#include "TestEditorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UTestEditorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UTestEditorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UTestEditorInteractiveTool* NewTool = NewObject<UTestEditorInteractiveTool>(SceneState.ToolManager);
...
void UTestEditorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UTestEditorInteractiveTool::Setup()
{
	...
	Properties = NewObject<UTestEditorInteractiveToolProperties>(this, "Measurement");
...
void UTestEditorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UTestEditorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UTestEditorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UTestEditorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UTestEditorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UTestEditorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UTestEditorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UTestEditorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UTestEditorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
