...
#include "TestEditorInteractiveTool.generated.h"
 ...
 */
UCLASS()
class TESTEDITOR_API UTestEditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class TESTEDITOR_API UTestEditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UTestEditorInteractiveToolProperties();
 ...
 */
UCLASS()
class TESTEDITOR_API UTestEditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTestEditorInteractiveToolProperties> Properties;
