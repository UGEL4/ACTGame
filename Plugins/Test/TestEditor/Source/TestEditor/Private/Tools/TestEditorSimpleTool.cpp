...
#include "TestEditorSimpleTool.h"
...
#define LOCTEXT_NAMESPACE "TestEditorSimpleTool"

/*
 * ToolBuilder implementation
 */

UInteractiveTool* UTestEditorSimpleToolBuilder::BuildTool(const FToolBuilderState& SceneState) const
{
	UTestEditorSimpleTool* NewTool = NewObject<UTestEditorSimpleTool>(SceneState.ToolManager);
...
void UTestEditorSimpleTool::SetWorld(UWorld* World)
{
	this->TargetWorld = World;
}


void UTestEditorSimpleTool::Setup()
{
	USingleClickTool::Setup();

	Properties = NewObject<UTestEditorSimpleToolProperties>(this);
	AddToolPropertySource(Properties);
}


void UTestEditorSimpleTool::OnClicked(const FInputDeviceRay& ClickPos)
{
