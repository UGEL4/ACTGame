...
#include "TestEditorEditorMode.generated.h"
 ...
 */
UCLASS()
class UTestEditorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_TestEditorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UTestEditorEditorMode();
	virtual ~UTestEditorEditorMode();
