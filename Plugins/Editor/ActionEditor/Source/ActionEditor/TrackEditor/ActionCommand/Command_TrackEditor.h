...
class ACTIONEDITOR_API FCommand_TrackEditor : public FMovieSceneTrackEditor
{
public:

    FCommand_TrackEditor(TSharedRef<ISequencer> InSequencer);
    ~FCommand_TrackEditor();
...
class FCommand_SectionEditor : public ISequencerSection, public TSharedFromThis<FCommand_SectionEditor>
{
public:
    FCommand_SectionEditor(UMovieSceneSection& InSection, TWeakPtr<ISequencer> InSequencer);
    virtual ~FCommand_SectionEditor();
